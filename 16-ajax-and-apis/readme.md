...
- Explain why synchronous program execution is not conducive requesting resources on the front end
- Explain what AJAX is and how it differs from traditional, synchronous resource request
- Explain what an API is and why they are so important, particularly on the web
- Explain what JSON is and how to use it
- Use the native `fetch` method to make asynchronous GET requests for data.
